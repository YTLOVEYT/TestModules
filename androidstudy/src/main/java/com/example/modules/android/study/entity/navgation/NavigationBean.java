package com.example.modules.android.study.entity.navgation;
...
/**
 * NavigationBean
 * Create By 樱桃 on 2019/2/17 16:03
 */
public class NavigationBean implements Parcelable
{
    ...
    {
        return "NavigationBean{" + "cid=" + cid + ", name='" + name + '\'' + ", articles=" + articles + ", isCheck=" + isCheck + '}';
    }
}
